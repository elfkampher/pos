...
class ModeloClientes{
	...
	static public function mdlEditarCliente($tabla, $datos){
		...
		$stmt = Conexion::conectar()->prepare("UPDATE $tabla SET nombre = :nombre, documento = :documento, email = :email, telefono = :telefono, direccion =  :direccion, fecha_nacimiento = :fecha_nacimiento WHERE id_cliente = :idCliente");
